        ...
        register(
            TableDescriptor(
                ...
                system_fields=[
                    ...
                    FieldDescriptor(column_name="data_type", csv_header="data_type:text", data_type="text"),
                    FieldDescriptor(column_name="is_system", csv_header="is_system:boolean", data_type="boolean"),
                    FieldDescriptor(column_name="display_order", csv_header="display_order:integer", data_type="integer"),
                    FieldDescriptor(column_name="options", csv_header="options:text", data_type="text", is_json=True, nullable=True),
                ],
