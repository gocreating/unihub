...
from core.serializers import AttributeDefinitionSerializer, AttributeValueSerializer, AttributeValueUpsertSerializer
...
class AttributeValueViewSet(viewsets.ViewSet):
    ...
    def bulk_upsert(self, request):
        ...
        return Response(AttributeValueSerializer(results, many=True).data, status=status.HTTP_200_OK)
