export default {
  ...
  'pages.io.sync.config.deviceName': '裝置名稱',
  ...
  'pages.io.sync.config.patGuide': '前往 GitHub → 設定 → 開發者設定 → Personal access tokens → Fine-grained tokens 建立 PAT。在你的私人儲存庫上授予 Contents: Read and Write 權限。',
