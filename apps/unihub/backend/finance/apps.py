    ...
    def ready(self) -> None:
        ...
        register(
            TableDescriptor(
                ...
                system_fields=[
                    ...
                    FieldDescriptor(column_name="open_datetime", csv_header="open_datetime:datetime", data_type="datetime", nullable=True),
                    FieldDescriptor(column_name="close_datetime", csv_header="close_datetime:datetime", data_type="datetime", nullable=True),
                ],
        ...
        register(
            TableDescriptor(
                ...
                system_fields=[
                    FieldDescriptor(column_name="id", csv_header="id:string", data_type="string", is_pk=True),
                    FieldDescriptor(column_name="base_currency", csv_header="base_currency:string", data_type="string"),
                    FieldDescriptor(column_name="quote_currency", csv_header="quote_currency:string", data_type="string"),
                    FieldDescriptor(column_name="rate", csv_header="rate:decimal", data_type="decimal"),
                    FieldDescriptor(column_name="date", csv_header="date:datetime", data_type="datetime"),
                ],
                has_user_attributes=False,
                import_order=5,
