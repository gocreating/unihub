...
**Status**: Implemented (all user stories, 2026-07-20); refinement rounds 1–6 clarified and implemented 2026-07-21/22 — kebab/inline-review UI, commit-rail polish, "Publish Selected Changes" label, full-document canvas background (FR-028), embedded checkout review (FR-029), full-height sider border (FR-030). Manual walk-throughs T044/T050 pending a human session
